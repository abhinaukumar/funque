...
from ..config import FunqueExternalConfig
from ..tools.reader import YuvReader
from ..tools.writer import YuvWriter
...
class Executor(TypeVersionEnabled):
    ...
    def _assert_an_asset(cls, asset):
        ...
        if cls._need_ffmpeg(asset):
            FunqueExternalConfig.get_and_assert_ffmpeg()
    ...
    def _open_ref_workfile(self, asset, fifo_mode):
        ...
        ffmpeg_cmd = ffmpeg_cmd.format(
            ffmpeg=FunqueExternalConfig.get_and_assert_ffmpeg(),
            src=asset.ref_path,
