...
from .. import ExternalProgramCaller, convert_pixel_format_ffmpeg2vmafexec
from .executor import Executor
from .niqe_train_test_model import NiqeTrainTestModel
...
from .feature_extractor import SsimFeatureExtractor, MsSsimFeatureExtractor, \
    VmafFeatureExtractor, PsnrFeatureExtractor, VmafIntegerFeatureExtractor
from .noref_feature_extractor import BrisqueNorefFeatureExtractor
...
class QualityRunner(Executor):
    ...
    the final quality score. You must:
        ...
        FeatureAssembler.
    For an example, follow FunqueQualityRunner.
    """
...
class VmafLegacyQualityRunner(QualityRunner):
    ...
    SVM_MODEL_FILE = FunqueConfig.model_path("other_models", "model_V8a.model")
...
class FunqueQualityRunnerModelMixin(object):
    ...
    def _assert_extension_format(cls, supported_formats, format):
        """
        >>> supported_formats = ['.pkl', '.json']
        >>> FunqueQualityRunner._assert_extension_format(supported_formats, '.pkl')
        >>> FunqueQualityRunner._assert_extension_format(supported_formats, '.pkl_2160')
        >>> FunqueQualityRunner._assert_extension_format(supported_formats, '.pkkl')
        Traceback (most recent call last):
        ...
        AssertionError: FunqueQualityRunner supports .pkl or .json model file, but the file format is: .pkkl
        >>> FunqueQualityRunner._assert_extension_format(supported_formats, '.json')
        >>> FunqueQualityRunner._assert_extension_format(supported_formats, '.json_720')
        >>> FunqueQualityRunner._assert_extension_format(supported_formats, '.jsonn')
        >>> FunqueQualityRunner._assert_extension_format(supported_formats, '.jsson')
        Traceback (most recent call last):
        ...
        AssertionError: FunqueQualityRunner supports .pkl or .json model file, but the file format is: .jsson
        """
...
class FunqueQualityRunner(FunqueQualityRunnerModelMixin, QualityRunner):
    ...
    # DEFAULT_MODEL_FILEPATH = FunqueConfig.model_path("nflxall_vmafv2.pkl") # trained with resource/param/vmaf_v2.py on private/resource/dataset/NFLX_dataset.py (30 subjects)

    # VERSION = '0.3' # using model nflxall_vmafv3.pkl, VmafFeatureExtractor VERSION 0.2.1
    # DEFAULT_MODEL_FILEPATH = FunqueConfig.model_path("nflxall_vmafv3.pkl") # trained with resource/param/vmaf_v3.py on private/resource/dataset/NFLX_dataset.py (30 subjects)
    ...
    # DEFAULT_MODEL_FILEPATH = FunqueConfig.model_path("nflxall_vmafv3a.pkl") # trained with resource/param/vmaf_v3.py on private/resource/dataset/NFLX_dataset.py (26 subjects)
    ...
    # ALGO_VERSION = 0
    # DEFAULT_MODEL_FILEPATH = FunqueConfig.model_path("nflxall_vmafv4.pkl")  # trained with resource/param/vmaf_v4.py on private/resource/dataset/NFLX_dataset.py (26 subjects)
    ...
    DEFAULT_MODEL_FILEPATH = FunqueConfig.model_path("vmaf_v0.6.1.json")
    ...
    def _get_vmaf_feature_assembler_instance(self, asset):
        ...
        optional_dict = self._load_model(asset).get_appended_info('feature_optional_dict')
        optional_dict2 = self._load_model(asset).get_appended_info('feature_optional_dict2')
...
class EnsembleFunqueQualityRunner(FunqueQualityRunner):
    TYPE = 'EnsembleVMAF'

    VERSION = '{}-Ensemble'.format(FunqueQualityRunner.VERSION)

    DEFAULT_MODEL_FILEPATH = [FunqueConfig.model_path("vmaf_float_v0.6.1.pkl"), FunqueConfig.model_path("vmaf_float_v0.6.1.pkl")]
...
class VmafPhoneQualityRunner(FunqueQualityRunner):
    TYPE = 'VMAF_Phone'

    VERSION = '{}-phone'.format(FunqueQualityRunner.VERSION)
...
class VmafossExecQualityRunner(QualityRunner):
    ...
    # VERSION = '0.3'
    # DEFAULT_MODEL_FILEPATH_DOTMODEL = FunqueConfig.model_path("nflxall_vmafv3.pkl.model")

    # VERSION = '0.3.1'
    # DEFAULT_MODEL_FILEPATH_DOTMODEL = FunqueConfig.model_path("nflxall_vmafv3a.pkl.model")

    # VERSION = '0.3.2'
    # ALGO_VERSION = 0
    # # DEFAULT_MODEL_FILEPATH_DOTMODEL = FunqueConfig.model_path("nflxall_vmafv4.pkl.model")
    # DEFAULT_MODEL_FILEPATH = FunqueConfig.model_path("nflxall_vmafv4.pkl")
...
class BootstrapFunqueQualityRunner(FunqueQualityRunner):
    TYPE = "BOOTSTRAP_VMAF"
    VERSION = FunqueQualityRunner.VERSION + '-' + 'M' + BootstrapLibsvmNusvrTrainTestModel.VERSION
    ALGO_VERSION = None

    # "vmaf_float_b_v0.6.3": plain bootstrapping, "vmaf_rb_v0.6.3": residue bootstrapping
    DEFAULT_MODEL_FILEPATH = FunqueConfig.model_path("vmaf_b_v0.6.3.json")
    ...
    def get_train_test_model_class(self):
        # overide FunqueQualityRunner.get_train_test_model_class
...
class BaggingFunqueQualityRunner(BootstrapFunqueQualityRunner):
    TYPE = "BAGGING_VMAF"
    VERSION = FunqueQualityRunner.VERSION + '-' + BootstrapLibsvmNusvrTrainTestModel.VERSION

    def _populate_result_dict(self, feature_result, pred_result):
        result_dict = super(BaggingFunqueQualityRunner, self)._populate_result_dict(feature_result, pred_result)
...
class NiqeQualityRunner(QualityRunner):
    ...
    DEFAULT_MODEL_FILEPATH = FunqueConfig.model_path('other_models', 'niqe_v0.1.pkl')
    ...
    def _get_niqe_feature_assembler_instance(self, asset):
        ...
        from .noref_feature_extractor import NiqeNorefFeatureExtractor
