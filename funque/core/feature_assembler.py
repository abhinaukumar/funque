...
from .custom_feature_extractors import * 
from .result import BasicResult
from .matlab_feature_extractor import StrredFeatureExtractor, SpEEDMatlabFeatureExtractor
    ...
    def run(self):
        ...
        for fextractor_type in self.feature_dict:
            ...
            runner = fextractor_class(
                 ...
                 optional_dict=dict(self.optional_dict) if self.optional_dict is not None else None
            )
