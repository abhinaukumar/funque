...
from ..tools.decorator import deprecated, override
from ..tools.misc import indices
from .mixin import TypeVersionEnabled
from .perf_metric import RmsePerfMetric, SrccPerfMetric, PccPerfMetric, \
...
class RegressorMixin(object):
    ...
    def get_stats(cls, ys_label, ys_label_pred, **kwargs):
        ...
        if split_test_indices_for_perf_ci:
            ...
            # replicate logic of BootstrapFunqueQualityRunner
...
class TrainTestModel(TypeVersionEnabled):
    ...
    def _calculate_normalization_params_clip_0to1(self, xys_2d):
        ...
        fmins = np.clip(fmins, None, fmaxs-1e-4)  # To avoid divide by zero when calculating slopes
