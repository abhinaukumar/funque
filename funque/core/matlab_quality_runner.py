...
from ..config import FunqueExternalConfig, FunqueConfig
from .executor import Executor
from ..tools.decorator import override
from ..tools.misc import run_process
from .feature_assembler import FeatureAssembler
from .matlab_feature_extractor import StrredFeatureExtractor, StrredOptFeatureExtractor, SpEEDMatlabFeatureExtractor, STMADFeatureExtractor, iCIDFeatureExtractor
from .quality_runner import QualityRunner, FunqueQualityRunner
...
class SpatioTemporalFunqueQualityRunner(FunqueQualityRunner):

    TYPE = 'STVMAF'

    VERSION = '1'

    DEFAULT_MODEL_FILEPATH = FunqueConfig.model_path("stvmaf", "stvmaf_v1.pkl")
