...
from .quality_runner import FunqueQualityRunner
...
class FunqueQualityRunnerWithLocalExplainer(FunqueQualityRunner):
    """Same as FunqueQualityRunner, except that it outputs additional LocalExplainer
    results. It shares the type 'VMAF' with FunqueQualityRunner, since the numeric
    ...
    VERSION = '{}-le1'.format(FunqueQualityRunner.VERSION)

    @classmethod
    def get_explanations_key(cls):
        return cls.get_scores_key() + '_exps'

    @override(FunqueQualityRunner)
    def _run_on_asset(self, asset):
        # Override FunqueQualityRunner._run_on_asset(self, asset), by adding
