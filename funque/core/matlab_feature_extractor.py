...
from ..config import FunqueConfig, FunqueExternalConfig
...
class MatlabFeatureExtractor(FeatureExtractor):
    ...
    def _assert_class(cls):
        ...
        FunqueExternalConfig.get_and_assert_matlab()
...
class StrredFeatureExtractor(MatlabFeatureExtractor):
    ...
    MATLAB_WORKSPACE = FunqueConfig.root_path('matlab', 'strred')
    ...
    def _generate_result(self, asset):
        ...
        strred_cmd = '''{matlab} -nodisplay -nosplash -nodesktop -r "run_strred('{ref}', '{dis}', {h}, {w}); exit;" >> {log_file_path}'''.format(
            matlab=FunqueExternalConfig.get_and_assert_matlab(),
...
class SpEEDMatlabFeatureExtractor(MatlabFeatureExtractor):
    ...
    MATLAB_WORKSPACE = FunqueConfig.root_path('matlab', 'SpEED')
...
class STMADFeatureExtractor(MatlabFeatureExtractor):
    ...
    MATLAB_WORKSPACE = FunqueConfig.root_path('matlab', 'STMAD_2011_MatlabCode')
...
class iCIDFeatureExtractor(MatlabFeatureExtractor):
   ...
   MATLAB_WORKSPACE = FunqueConfig.root_path('matlab', 'cid_icid')
