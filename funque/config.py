...
class FunqueExternalConfig(object):
...
class FunqueConfig(object):
    ...
    def tools_resource_path(cls, *components):
        return cls.root_path('funque', 'tools', 'resource', *components)
...
class DisplayConfig(object):
    ...
    def show(**kwargs):
        ...
        if 'write_to_dir' in kwargs:
            ...
            filedir = kwargs['write_to_dir'] if kwargs['write_to_dir'] is not None else FunqueConfig.workspace_path('output')
